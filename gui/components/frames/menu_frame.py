...
class MenuFrame(customtkinter.CTkFrame):
    ...
    def open_popup_form(self):
        form = DynamicPopup(self.app, "Add Menu Item", ["Name:", "Price:"], dbAPI=self.dbAPI, create_menu=True)
        ...
        menu_resources = [self.dbAPI.add_menu_resource(item, amount) for item, amount in form.items]
